...
function defaults(){ return ['updated' => '', 'images' => new stdClass(), 'text' => new stdClass(), 'themes' => [], 'items' => []]; }
...
if ($method === 'POST') {
  ...
  $clean = ['updated' => date('c'), 'images' => $images, 'text' => $text, 'themes' => $themes, 'items' => $items];
